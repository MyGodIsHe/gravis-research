...
### Шаг 5 - редактор на Unity (отменён)
...
### Шаг 6 - редактор на UE4

#### Шаг 6.1 - Работа с узлами в простом графе
#### Шаг 6.2 - Работа с подпространством
#### Шаг 6.3 - Загрузка и сохранение графа
